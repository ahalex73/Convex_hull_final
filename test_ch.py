...
def test_square():
    ...
    # Define the expected convex hull
    known_square_convex_hull = [(0,0),(0,4),(4,4),(4,0),(0,0)]  # Closed loop
    
    # Call the function to compute the convex hull
    result = find_convex_hull(input_points)
    
    # Assert that the computed convex hull matches the expected convex hull
    assert sorted(result) == sorted(known_square_convex_hull)
